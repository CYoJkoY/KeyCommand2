...
public class KeyCommandMod {
    ...
    public void onRenderGameOverlay(RenderGameOverlayEvent.Post event) {
        if (event.getType() == RenderGameOverlayEvent.ElementType.ALL && showCoordinates) {
            ...
            if (player != null) {
                ...
                int scaledMouseX = Mouse.getX() * sr.getScaledWidth() / mc.displayWidth;
                int scaledMouseY = sr.getScaledHeight() - Mouse.getY() * sr.getScaledHeight() / mc.displayHeight - 1;
    ...
    public static class GuiInventory extends GuiScreen {
        ...
        private final List<String> categories = Arrays.asList("自动操作");
        ...
        // 修改静态字段为自动获取
        public static int referenceWidth = Toolkit.getDefaultToolkit().getScreenSize().width;
        public static int referenceHeight = Toolkit.getDefaultToolkit().getScreenSize().height;
        public static double currentScaleX = (double)referenceWidth / 1920.0;
        public static double currentScaleY = (double)referenceHeight / 1200.0;
		
        // 新增自动进食相关字段
        private static final File CONFIG_FILE = new File("config/keycommand_autoeat.json");
        ...
        public GuiInventory() {
            ...
            // 新增坐标显示切换按钮
            AutoItems.add("togglecoords"); AutoItemNames.add("坐标显示");
            // 新增循环设置按钮(+)
            AutoItems.add("setloop"); AutoItemNames.add("循环次数");
            AutoItems.add("stop"); AutoItemNames.add("停止运行");
            // 自动操作分类中添加吃食物按钮
            AutoItems.add("autoeat"); AutoItemNames.add("自动进食");
        ...
        public static void initializePathSequences() {
            ...
            Daily1.addAction(new DelayAction(3));
            Daily1.addAction(player -> GuiInventory.simulateMouseClick(935, 778, true));
            Daily1.addAction(player -> GuiInventory.simulateMouseClick(930, 780, true));
            Daily1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_ESCAPE,true));
            Daily1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_ESCAPE,false));
            ...
            At1.addAction(new DelayAction(3));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1214, 396, true));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1231, 405, true));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1200, 485, true));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1204, 570, true));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1195, 654, true));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1205, 736, true));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1195, 824, true));
            At1.addAction(player -> GuiInventory.simulateMouseClick(1196, 910, true));
            At1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_ESCAPE,true));
            At1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_ESCAPE,false));
            ...
            Collect1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_U,true));
            Collect1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_U,false));
            Collect1.addAction(player -> autoChestClick(player, 5));
            Collect1.addAction(player -> autoChestClick(player, 12));
            Collect1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_ESCAPE,true));
            Collect1.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_ESCAPE,false));
            ...
            TJP18.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            TJP18.addAction(new DelayAction(100));
            ...
            SMGD13.addAction(player -> GuiInventory.takeAllItemsFromChest());
            SMGD13.addAction(new DelayAction(48));
            SMGD13.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            SMGD13.addAction(new DelayAction(100));
            ...
            PathStep XSZZZ7 = new PathStep(new double[]{-1338, 100, -2274});
            ...
            XSZZZ11.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSZZZ11.addAction(new DelayAction(48));
            XSZZZ11.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            XSZZZ11.addAction(new DelayAction(100));
            ...
            PathStep XSLG1 = new PathStep(new double[]{-1340, 102, -2441});
            XSLG1.addAction(new DelayAction(16));
            XSLG1.addAction(player -> rightClickOnBlock(player, new BlockPos(-1340, 102, -2443)));
            XSLG1.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG1.addAction(new DelayAction(48));
            
            PathStep XSLG2 = new PathStep(new double[]{-1310, 103, -2392});
            XSLG2.addAction(new DelayAction(16));
            XSLG2.addAction(player -> rightClickOnBlock(player, new BlockPos(-1308, 103, -2392)));
            XSLG2.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG2.addAction(new DelayAction(48));
            
            PathStep XSLG3 = new PathStep(new double[]{-1315, 103, -2398});
            XSLG3.addAction(new DelayAction(16));
            XSLG3.addAction(player -> rightClickOnBlock(player, new BlockPos(-1317, 103, -2399)));
            XSLG3.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG3.addAction(new DelayAction(48));
            XSLG3.addAction(player -> rightClickOnBlock(player, new BlockPos(-1316, 103, -2400)));
            XSLG3.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG3.addAction(new DelayAction(48));
            
            PathStep XSLG4 = new PathStep(new double[]{-1338, 103, -2390});
            XSLG4.addAction(new DelayAction(16));
            XSLG4.addAction(player -> rightClickOnBlock(player, new BlockPos(-1341, 103, -2392)));
            XSLG4.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG4.addAction(new DelayAction(48));
            XSLG4.addAction(player -> rightClickOnBlock(player, new BlockPos(-1334, 103, -2392)));
            XSLG4.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG4.addAction(new DelayAction(48));
            
            PathStep XSLG5 = new PathStep(new double[]{-1353, 103, -2389});
            XSLG5.addAction(new DelayAction(16));
            XSLG5.addAction(player -> rightClickOnBlock(player, new BlockPos(-1355, 103, -2387)));
            XSLG5.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG5.addAction(new DelayAction(48));
            
            PathStep XSLG6 = new PathStep(new double[]{-1353, 103, -2417});
            XSLG6.addAction(new DelayAction(16));
            XSLG6.addAction(player -> rightClickOnBlock(player, new BlockPos(-1351, 103, -2420)));
            XSLG6.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG6.addAction(new DelayAction(48));
            XSLG6.addAction(player -> rightClickOnBlock(player, new BlockPos(-1351, 103, -2414)));
            XSLG6.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG6.addAction(new DelayAction(48));
            
            PathStep XSLG7 = new PathStep(new double[]{-1344, 110, -2402});
            XSLG7.addAction(new DelayAction(16));
            XSLG7.addAction(player -> rightClickOnBlock(player, new BlockPos(-1344, 110, -2404)));
            XSLG7.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG7.addAction(new DelayAction(48));
            
            PathStep XSLG8 = new PathStep(new double[]{-1331, 110, -2404});
            XSLG8.addAction(new DelayAction(16));
            XSLG8.addAction(player -> rightClickOnBlock(player, new BlockPos(-1330, 110, -2402)));
            XSLG8.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG8.addAction(new DelayAction(48));
            
            PathStep XSLG9 = new PathStep(new double[]{-1342, 110, -2418});
            XSLG9.addAction(new DelayAction(16));
            XSLG9.addAction(player -> rightClickOnBlock(player, new BlockPos(-1344, 110, -2420)));
            XSLG9.addAction(player -> GuiInventory.takeAllItemsFromChest());
            XSLG9.addAction(new DelayAction(48));
            XSLG9.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            XSLG9.addAction(new DelayAction(100));
            ...
            LWT12.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            LWT12.addAction(new DelayAction(100));
            ...
            XYXW12.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            XYXW12.addAction(new DelayAction(100));
            ...
            JCZ5.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            JCZ5.addAction(new DelayAction(100));
            ...
            PathStep JCZ12 = new PathStep(new double[]{-1352, 95, -2489});
            JCZ12.addAction(new DelayAction(16));
            JCZ12.addAction(player -> rightClickOnBlock(player, new BlockPos(-1351, 95, -2490)));
            JCZ12.addAction(player -> GuiInventory.takeAllItemsFromChest());
            JCZ12.addAction(new DelayAction(48));
            JCZ12.addAction(player -> setPlayerViewAngles(player, 45.0f, -20.0f));
            JCZ12.addAction(new DelayAction(5));
            JCZ12.addAction(player -> GuiInventory.dropItemsByNameFilter("[布料,线团,干柴堆],[高级布料]"));
            JCZ12.addAction(new DelayAction(100));
        ...
        // 模拟按下（单键） xxx.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_F3,true));
        // 模拟松开（单键） xxx.addAction(player -> GuiInventory.simulateKeyWithJS(Keyboard.KEY_F3, false));
        ...
        private static boolean isSingleUseCommand(String command) {
            String[] forbiddenCommands = {"收集", "每日", "在线"};
     ...
     // 右键点击方块（增加射线追踪验证）
        ...
        private static final ScriptEngine jsEngine = scriptEngineManager.getEngineByName("JavaScript");
        
        // 添加新的按键模拟方法
        public static void simulateKeyWithJS(int keyCode, boolean pressed) {
            // 确保在主线程执行
            Minecraft.getMinecraft().addScheduledTask(() -> {
                try {
                    String keyName = Keyboard.getKeyName(keyCode).toUpperCase();
                    // 处理特殊按键名称映射
                    ...
                    // 使用独立Robot实例
                    jsEngine.put("mcRobot", new java.awt.Robot());
                    jsEngine.eval(
                        "mcRobot.key" + (pressed ? "Press" : "Release") + 
                        "(java.awt.event.KeyEvent.VK_" + keyName + ");"
                    );
                    LOGGER.info("安全模拟按键: {} 状态: {}", keyName, pressed ? "按下" : "松开");
                } catch (Exception e) {
                    LOGGER.error("安全模拟按键失败", e);
                }
            });
        }
        ...
        private static double getDisplayScale() {
            ...
            double logicalWidth = Toolkit.getDefaultToolkit().getScreenSize().getWidth();
            return width / logicalWidth;
        }
        ...
        public static void simulateMouseClick(int x, int y, boolean isLeftClick) {
            Minecraft.getMinecraft().addScheduledTask(() -> {
                try {
                    // 应用自动缩放比例
                    int scaledX = (int)(x * currentScaleX);
                    int scaledY = (int)(y * currentScaleY);
         ...
         *                  第二部分是白名单（名称包含则保留）
         */
        public static void dropItemsByNameFilter(String filterStr) {
            EntityPlayerSP player = mc.player;
            if (player == null) return;

            // 解析黑名单和白名单
            String[] parts = filterStr.split("\\]\\s*,\\s*\\[", 2);
            List<String> blacklist = parseFilterList(parts.length > 0 ? parts[0] : "");
            List<String> whitelist = parseFilterList(parts.length > 1 ? parts[1] : "");
        ...
        // 解析过滤列表（支持带空格的名称）
        private static List<String> parseFilterList(String part) {
            return Arrays.stream(part.replaceAll("[\\[\\]]", "").split("\\s*,\\s*"))
                         .filter(s -> !s.isEmpty())
        ...
        public static void takeAllItemsFromChest() {
        	...
        	new DelayAction(5, () -> {
                if (mc.currentScreen instanceof GuiChest) {
                    ...
                    int chestSlots = gui.inventorySlots.inventorySlots.size() - 36;
                    ...
                    if (slotsToProcess.isEmpty()) {
                        LOGGER.info("检测到空箱子，跳过物品转移操作");
                        if (mc.currentScreen != null) {
                            mc.displayGuiScreen(null); // 调用Minecraft原生关闭GUI方法
                        }
                        return;
                    }
...
public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (currentCategory.equals("自动操作")) {
    	// 新增自动吃食物状态显示（在页码上方添加）
    	String autoEatStatus = "自动进食: " + (autoEatEnabled ? "启用" : "禁用");
    	fontRenderer.drawStringWithShadow(autoEatStatus, x + 55, y + 170, 0x555555); 
    ...
    super.drawScreen(mouseX, mouseY, partialTicks);
            ...
            for (int i = 0; i < 20; i++) {
                ...
                if (mouseX >= itemX && mouseX <= itemX + 30 && 
                        ...
                        if (command.startsWith("path:")) {
                        	...
                        	if (!isSingleUseCommand(sequenceName)) {
                            ...
                            if (command.equals("togglecoords")) {
                                ...
                                LOGGER.info("自动进食已" + (autoEatEnabled ? "启用" : "禁用"));
                            }
                        } else {
        ...
        public static class EventListener {
            ...
            private static void checkAutoEat(EntityPlayerSP player) {   
                if (!autoEatEnabled || player.getFoodStats().getFoodLevel() > 15) return;
                
             // 新增进食状态追踪
                if (isEating) {
                    if (mc.currentScreen != null) {
                        LOGGER.warn("检测到GUI打开，终止进食流程");
                        restoreHotbarSlot(player);
                        isEating = false;
                        return;
                    }
                    return;
                ...
                if (originalHotbarSlot != -1) {
                    if (mc.currentScreen == null) {  // 确保没有打开任何GUI
                    	restoreHotbarSlot(player);
                        LOGGER.info("安全恢复物品栏");
                    } 
                }
            ...
            // 增强恢复方法的安全检查
            private static void restoreHotbarSlot(EntityPlayerSP player) {
                try {
                    if (originalHotbarSlot != -1 && mc.currentScreen == null 
                        && player.inventory.mainInventory.size() > originalHotbarSlot) {
                        player.inventory.currentItem = originalHotbarSlot;
                        player.inventory.setInventorySlotContents(originalHotbarSlot, swappedItem);
                        originalHotbarSlot = -1;
                        LOGGER.info("成功恢复物品栏位置");
                    } else if (originalHotbarSlot == -1 || mc.currentScreen != null 
                    		|| player.inventory.mainInventory.size() <= originalHotbarSlot) {
                    	LOGGER.warn("检测到GUI打开，延迟恢复物品栏");
                    ...
                    LOGGER.error("恢复物品栏时发生异常", e);
                    originalHotbarSlot = -1; // 强制重置状态
                }
            }
            ...
            private static void swapItemWithHotbar(EntityPlayerSP player, int sourceSlot) {
                // 添加槽位有效性检查
                if (sourceSlot < 0 || sourceSlot >= player.inventory.mainInventory.size()) {
                ...
                LOGGER.info("交换物品: 将快捷栏第{}格的{}与背包第{}格食物交换", 
                    currentHotbar+1, GuiInventory.swappedItem.getDisplayName(), sourceSlot+1);
            }
         ...
         // 新增物品交换方法
            ...
            private static void handleEatingProcess(EntityPlayerSP player, int slot) {
                ...
                // 新增暂停逻辑
                EventListener.instance.setPaused(true);
                    ...
                    new DelayAction(32, () -> {
                    	...
                    	new DelayAction(3, () -> {
                    		if (GuiInventory.originalHotbarSlot != -1) {
                            	...
                            	// 恢复路径序列执行
                                EventListener.instance.setPaused(false);
        ...
        public static class LoopCountInputGui extends GuiScreen {
            ...
            protected void actionPerformed(GuiButton button) throws IOException {
                ...
                if (button.id == 101) { // 自动进食开关
                    ...
                    LOGGER.info("自动进食功能已{}", autoEatEnabled ? "启用" : "禁用");
                }
            }
